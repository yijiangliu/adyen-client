...
public class Cancel implements Command {
    private static Logger LOG = LoggerFactory.getLogger(Cancel.class);
    private Context context;

    public Cancel(@NotNull Context context) {
    ...
    public void execute() {
        ...
        ModificationResponse res = context.getClient().cancel(req);
